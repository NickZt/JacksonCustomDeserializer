...
public class TimeStampLongFromStringOrLongDeserializer extends StdScalarDeserializer<Long> {
    ...
    private void advanceToToken(JsonParser jp) throws IOException {
        do {
    ...
    public Long deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        if (jp.currentTokenId() == JsonTokenId.ID_NUMBER_INT) {
            ...
            return parceDateString(timestampStr);
        }
    }

    private long parceDateString(String timestampStr) throws IOException {
        try {
